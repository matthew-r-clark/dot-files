return {
    ...
    config = function()
        ...
        -- local dap_vscode_js_debug_path = vim.fn.stdpath('data') .. '/lazy/vscode-js-debug'
        -- local dap_vscode_js_debug_path = vim.fn.stdpath('data') .. '/mason/packages/js-debug-adapter'
        local dap_vscode_js_debug_path = vim.fn.stdpath('data') .. '/lazy/vscode-js-debug/out/src/vsDebugServer.js'
        require('dap-vscode-js').setup({
            -- node_path = 'node', -- Path of node executable. Defaults to $NODE_PATH, and then 'node'
            -- debugger_path = '(runtimedir)/site/pack/packer/opt/vscode-js-debug', -- Path to vscode-js-debug installation.
            debugger_path = dap_vscode_js_debug_path,
